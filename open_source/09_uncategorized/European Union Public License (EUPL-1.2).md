...
Please see [https://joinup.ec.europa.eu/community/eupl/news/understanding-eupl-v12](https://joinup.ec.europa.eu/community/eupl/news/understanding-eupl-v12) for translations of the EUPL-1.2 into various European languages. (This [matrix](http://joinup.ec.europa.eu/software/page/eupl/eupl-compatible-open-source-licences#section-2) showing the EUPL-1.2's compatibility with other OSI-approved licenses may also be useful.)
